...
(function (a) {
    a.addFlex = function (n, r) {
        ...
        x = {hset: {}, rePosDrag: function () {
                ...
                a(x.block).css({height: i, marginBottom: (i * -1)});
                g = x.bDiv.offsetTop + i;
                if (r.height != "auto" && r.resizable) {
                    g = x.vDiv.offsetTop
                }
                a(x.rDiv).css({height: g})
                ...
                if (t == "colresize") {
                    ...
                    if (t == "vresize") {
                        ...
                        this.vresize = {h: r.height, sy: s.pageY, w: r.width, sx: s.pageX, hgo: i}
                    } else {
                        if (t == "colMove") {
                            a(x.nDiv).hide();
                            a(x.nBtn).hide();
                            ...
                            a(this.colCopy).css({position: "absolute", "float": "left", display: "none", textAlign: p.align});
                ...
                if (this.colresize) {
                    ...
                    if (this.vresize) {
                        ...
                        if (this.colCopy) {
                            ...
                            a(this.colCopy).css({top: t.pageY + 10, left: t.pageX + 20, display: "block"})
                        }
                    }
                }
            }, dragEnd: function () {
...
//                }
                ...
                p = [{name: "page", value: r.newp}, {name: "rp", value: r.rp}, {name: "sortname", value: r.sortname}, {name: "sortorder", value: r.sortorder}, {name: "query", value: r.query}, {name: "qtype", value: r.qtype}];
                if (r.params) {
                    for (i = 0; i < r.params.length; i++) {
                        p[p.length] = r.params[i]
                    }
                }
                a.ajax({type: r.method, url: r.url, data: p, dataType: r.dataType, success: function (s) {
                        x.addData(s)
                        //foi adicionado esse parte de codigo chamando o onsucess sempre nao importando se deu certo ou nao
                        if (r.onSuccess) {
                            r.onSuccess()
                        }
                    }, error: function (s) {
                ...
                a("tbody tr td", x.bDiv).each(function () {
                    ...
                    if (s != null) {
                        ...
                        a(p).css({textAlign: s.align, width: a("div:first", s)[0].style.width});
                        if (s.hide) {
                ...
                return{ht: E, wt: t, top: D, left: i, pdl: F, pdt: s, pht: g, pwt: G}
            }, addRowProp: function () {
                var g;
        ...
        if (r.buttons) {
            ...
            for (v = 0; v < r.buttons.length; v++) {
                ...
                if (!k.separator) {
                    ...
                    w.className = "fbutton";
                    w.innerHTML = "<div><button><i></i> " + k.name + "</button></div>";
                    if (k.bclass) {
                        a("button", w).addClass('btn btn-' + k.bclass);
                        a("i", w).addClass('fa fa-' + k.iclass).css({
                            color: k.icolor !== undefined ? k.icolor : '#008BA9'
                        });
                    }
                    w.onpress = k.onpress;
                    w.name = k.name;
        ...
        a("thead tr:first th", x.hDiv).each(function () {
            ...
            a(q).css({textAlign: this.align, width: this.width + "px"});
            ...
            a(this).empty().append(q).removeAttr("width").mousedown(function (g) {
                ...
                if (x.colCopy) {
                    ...
                    if (!x.colresize) {
                        ...
                        a(x.nDiv).hide();
                        a(x.nBtn).hide();
                        /*a(x.nBtn).css({left:i,top:a(x.hDiv).offset().top}).show();*/s = parseInt(a(x.nDiv).width());
        ...
        a(n).before(x.bDiv);
        a(x.bDiv).css({height: (r.height == "auto") ? "auto" : r.height + "px"}).scroll(function (g) {
            x.scroll()
        }).append(n);
        if (r.height == "auto") {
        ...
        if (f != null) {
            ...
            a("thead tr:first th", x.hDiv).each(function () {
                ...
                a(g).css({height: a(x.bDiv).height() + a(x.hDiv).height()}).mousedown(function (i) {
        ...
        if (r.usepager) {
            ...
            a("div", x.pDiv).html(' <div class="pGroup"> <div class="pFirst pButton"><span></span></div><div class="pPrev pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pcontrol">' + Itarget.lang.grids.pagina + ' <input type="text" size="4" value="1" /> ' + Itarget.lang.grids.de + ' <span> 1 </span></span></div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pNext pButton"><span></span></div><div class="pLast pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pReload pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pPageStat"></span></div>');
            ...
            if (r.searchitems) {
                ...
                a(x.sDiv).append("<div class='sDiv2'>" + Itarget.lang.grids.quicksearch + " <input type='text' size='30' name='q' class='qsbox' /> <select name='qtype'>" + e + "</select> <input type='button' value='" + Itarget.lang.grids.clear + "' /></div>");
        ...
        a(x.iDiv).addClass("iDiv").css({display: "none"});
        ...
        if (a.browser.msie && a.browser.version < 7) {
            a(".hDiv,.bDiv,.mDiv,.pDiv,.vGrip,.tDiv, .sDiv", x.gDiv).css({width: "100%"});
