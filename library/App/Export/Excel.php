...
class App_Export_Excel extends PHPExcel {
    ...
    public function export($campos, $linhas, $nomeArquivo = 'relatorio') {
        ...
        $this->getProperties()->setCreator("iTarget Tecnologia");
        $this->getProperties()->setLastModifiedBy("iTarget Tecnologia");
        ...
        $this->getActiveSheet()->setTitle('iTarget Tecnologia');
