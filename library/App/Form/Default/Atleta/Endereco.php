...
class App_Form_Default_Pessoa_Endereco extends App_Form_Abstract {
    ...
    public function __construct($options = null, $tipo = null) {
        ...
        $paisModel = new PaisTable();
        $paises = $paisModel->getPaises();

        $ufModel = new Uf();
        $ufs = $ufModel->getEstados();

        $tipoLogradouroModel = new TiposLogradouro();
        $tiposLogradouros = $tipoLogradouroModel->getTiposLogradouro();
        ...
        $pessoa = new Zend_Form_Element_Hidden('pessoa_id', $opcoesPadrao);
