...
class App_Mail_InscricaoVoucher {
    ...
    public static function enviar($dados) {
        ...
        $inscricaoTable = new InscricaoTable();
        ...
        $params['tes.id'] = TiposEmails::INSCRICAOVOUCHER;
    ...
    protected static function enviarGrupo($dados) {
        ...
        $arqEmailIns = 'evento/inscricoes/emails/' . str_replace('.', '-', CLIENTE) . '/' . $centroCusto . '-baixa-' . $idioma . '.phtml';
        $file = MODULES_PATH . 'icongresso/views/scripts/' . $arqEmailIns;
